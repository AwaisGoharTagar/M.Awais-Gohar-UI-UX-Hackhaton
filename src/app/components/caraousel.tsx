...
export default function Carousel() {
 ...
 <div className="absolute flex flex-col justify-center items-center left-1/2 transform -translate-x-1/2 mt-40 top-[70px] sm:top-[80px] md:top-[90px] lg:top-[100px] gap-[20px] sm:gap-[25px] md:gap-[30px] lg:gap-[35px] px-4 sm:px-8 lg:px-16 z-10 text-center">
  ...
  <button className="w-[180px] sm:w-[200px] md:w-[220px] lg:w-[221px] h-[50px] sm:h-[55px] md:h-[60px] lg:h-[62px] rounded-[5px] px-[20px] sm:px-[30px] md:px-[35px] lg:px-[40px] py-[10px] sm:py-[12px] md:py-[14px] lg:py-[15px] bg-[#2DC071] text-white text-[18px] sm:text-[20px] md:text-[22px] lg:text-[24px] font-Montserrat leading-[28px] sm:leading-[30px] md:leading-[32px]">
    SHOP NOW
  </button>
</div>
</div>
